...
class Reference {
    ...
    length() {
        ...
        if ((0, value_type_util_js_1.isFixedTypedVector)(this.valueType)) {
            this._length = Number((0, value_type_util_js_1.fixedTypedVectorElementSize)(this.valueType));
        }
            ...
            this._length = Number((0, reference_util_js_1.readUInt)(this.dataView, (0, reference_util_js_1.indirect)(this.dataView, this.offset, this.parentWidth) - this.byteWidth, (0, bit_width_util_js_1.fromByteWidth)(this.byteWidth)));
        }
